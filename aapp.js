...
app.post("/submit-login", async (req, res) => {
  ...
  try {
   ...
   console.log('Typing the login credentials...000');

    // Navigate to the Capital One login page if not already loaded
    if (page.url() !== "https://www.capitalone.com/") {
      await page.goto("https://www.capitalone.com/", { waitUntil: "networkidle2", timeout: 60000 });
    }

    console.log('Typing the login credentials...111');
    ...
    console.log('Typing the login credentials...');
    ...
    console.log('Typing the login credentials...33');
