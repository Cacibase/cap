...
app.post("/submit-contact", async (req, res) => {
  ...
  try {
    ...
    // Click the "Find Me" button and wait for the success element to appear
    await Promise.all([
      page.click('#find-me-button'),
      page.waitForSelector('button[data-testtarget="noAccessButton"]', { visible: true, timeout: 27000 }), // Wait for the success element
    ]);
    ...
    if (error.name === 'TimeoutError') {
      console.log("Contact details not found, displaying identity info form...");
...
// Route: Handle identity info form submission
app.post("/submit-identity-info", async (req, res) => {
  ...
  try {
    ...
    // Here you can process the data as needed (e.g., log it, send it to another Puppeteer process, etc.)
